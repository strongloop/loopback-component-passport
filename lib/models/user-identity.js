     ...
     if (typeof options.profileToUserFields !== 'undefined') {
       for (var key in options.profileToUserFields) {
         ...
         if (fieldName.search('.') !== -1) {
           ...
           if (typeof profile[keys[0]] !== 'undefined' && profile[keys[0]]) {
             var value = profile;
           ...
           if (typeof profile[options.profileToUserFields[key]] !== 'undefined' &&
           profile[options.profileToUserFields[key]]) {
             value = profile[options.profileToUserFields[key]];
             userObj[key] = value;
           }
         }
       }
