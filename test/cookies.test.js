...
describe('cookies', function() {
  ...
  before('configure ldap strategy', function() {
    var passportConfigurator = new PassportConfigurator(app);

    // mock a strategy to work with
    function PassportLdapStrategy(options, verify) {};
    PassportLdapStrategy.prototype.authenticate = function(req, options) {};
    mock('passport-ldapauth', PassportLdapStrategy);
    ...
    passportConfigurator.configureProvider('ldap-login', options);
  });
